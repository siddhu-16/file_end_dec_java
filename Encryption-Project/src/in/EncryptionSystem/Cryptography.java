...
public class Cryptography extends JFrame implements ActionListener
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2586460727795280581L;
...
int wdth,hight;
    ...
    public Cryptography() {
		...
		buttonPanel1.setBackground(new java.awt.Color(173, 216, 230));
		buttonPanel1.setForeground(Color.red);
		buttonPanel2.setBackground(new java.awt.Color(173, 216, 230));
